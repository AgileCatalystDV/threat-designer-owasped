...
# Local infrastructure endpoints (overrides AWS for local/Docker deployments)
ENV_DYNAMODB_ENDPOINT = "DYNAMODB_ENDPOINT"
...
ENV_INFERENCE_BASE_URL = "INFERENCE_BASE_URL"
ENV_INFERENCE_API_KEY = "INFERENCE_API_KEY"
